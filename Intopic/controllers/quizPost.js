...
module.exports = async (req, res) => {
    ...
    const chatGptMessage = `Create a quiz with 5 questions (trueFalse, multipleChoice, singleChoice) with below content after sample json format and return the response in the given JSON format
    {
    ...
    JSON format over and the content is below. If content is less, create quiz about that topic.
